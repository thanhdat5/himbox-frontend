...
const PasswordControl = ({ value, onChange, required }: PasswordControlProps) => {
    const [showPassword, setShowPassword] = useState(false);
    return <div className="hb-form-control-wrap">
        <FormControl value={value} onChange={onChange} required={required} type={showPassword ? 'text' : 'password'} />
