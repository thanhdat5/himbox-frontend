...
import { convertNumber, extractError } from "../../utils/helpers";
                        ...
                        <div className="h-100 d-flex flex-column justify-content-between">
                            <div className="mb-4 mb-md-0">
                                    ...
                                    <Col md={6}>
                                        ...
                                        <div className="hb-package-item-line">
                                            ...
                                            <div className="hb-package-item-value">
                                                ...
                                                <span>= {selectedPackage.him_amount / (get(prices, 'dot_price', 1) / get(prices, 'him_price', 1))} DOT</span>
                                            </div>
                                        </div>
                                    </Col>
                                </Row>
                                ...
                                <div className="hb-package-item-line hb-package-item-price">
                                    ...
                                    <div className="hb-package-item-value">
                                        <b>{selectedPackage.dot_amount + selectedPackage.him_amount / (get(prices, 'dot_price', 1) / get(prices, 'him_price', 1))} DOT</b>
                                        <span>= {(selectedPackage.dot_amount + selectedPackage.him_amount / (get(prices, 'dot_price', 1) / get(prices, 'him_price', 1))) * get(prices, 'dot_price', 0)} $</span>
                                    </div>
                                </div>
                            </div>
