...
const HBPoolStatistics2 = () => {
    ...
    return <div className="hb-pool-statistics">
        <Row className="mb-3 mb-lg-4">
            ...
            <Col md={3} xs={6} className="mb-3 mb-lg-4">
                <HBStatisticCard label="Claimed" value={formatNumberDownRound(Number(get(himSaleUserInfo, '2', 0)) / 10 ** 6)} subValue="HIM" className="h-100" />
            </Col>
            <Col md={3} xs={6} className="mb-3 mb-lg-4">
                <HBStatisticCard label="Claimable" value={formatNumberDownRound(Number(get(himSaleUserInfo, '1', 0) - get(himSaleUserInfo, '2', 0)) / 10 ** 6)} subValue="HIM" className="h-100" />
            </Col>
            <Col md={3} xs={6} className="mb-3 mb-lg-4">
                <HBStatisticCard label="USDT Purchased" value={formatNumberDownRound(Number(get(himSaleUserInfo, '0', 0)) / 10 ** 6)} subValue="USDT" className="h-100" />
            </Col>
        </Row>
    </div>
}
